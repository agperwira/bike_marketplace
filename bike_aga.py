...
bikes = {
    "S1": {"name": "Mountain Bike", "price": 200, "threshold": 150, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Versatile mountain bike designed for durability and comfort."},
    "S2": {"name": "Road Bike", "price": 160, "threshold": 130, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Road bike built for speed and performance on smooth surfaces."},
    "S3": {"name": "Hybrid Bike", "price": 180, "threshold": 140, "image": r"..\bike_marketplace\Polygon 4.jpg", "description": "Hybrid bike perfect for city rides and off-road trails."},
    "S4": {"name": "Electric Bike", "price": 300, "threshold": 250, "image": r"..\bike_marketplace\Electric Polygon.png", "description": "Electric bike offering a smooth and fast riding experience."},
    "S5": {"name": "BMX Bike", "price": 120, "threshold": 100, "image": r"..\bike_marketplace\Polygon 4_.png", "description": "BMX bike suitable for tricks and off-road adventures."},
    "S6": {"name": "Folding Bike", "price": 220, "threshold": 180, "image": r"..\bike_marketplace\Polygon 6.jpg", "description": "Compact folding bike, easy to store and transport."},
    "S7": {"name": "Fat Tire Bike", "price": 250, "threshold": 200, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Bike with fat tires for riding on sand, snow, or rough terrain."},
    "S8": {"name": "Gravel Bike", "price": 270, "threshold": 220, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Gravel bike built for rough roads and off-road trails."},
    "S9": {"name": "Cruiser Bike", "price": 150, "threshold": 120, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Comfortable cruiser bike for leisurely rides."},
    "S10": {"name": "Kids Bike", "price": 100, "threshold": 80, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Kid-friendly bike designed for safety and fun."},
    "S11": {"name": "Touring Bike", "price": 280, "threshold": 240, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Bike designed for long-distance touring and carrying cargo."},
    "S12": {"name": "Track Bike", "price": 300, "threshold": 250, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Track bike optimized for racing on velodromes."},
    "S13": {"name": "City Bike", "price": 130, "threshold": 100, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "City bike designed for commuting and urban riding."},
    "S14": {"name": "Adventure Bike", "price": 290, "threshold": 240, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Adventure bike built for exploring various terrains."},
    "S15": {"name": "Beach Cruiser", "price": 140, "threshold": 110, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Stylish beach cruiser bike for casual seaside rides."},
    "S16": {"name": "Enduro Bike", "price": 320, "threshold": 270, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "High-performance enduro bike for mountain trails."},
    "S17": {"name": "Cyclocross Bike", "price": 275, "threshold": 225, "image": r"..\bike_marketplace\Polygon 1.jpg", "description": "Bike for cyclocross racing and mixed-terrain adventures."},
    "S18": {"name": "Fixed Gear Bike", "price": 150, "threshold": 120, "image": r"..\bike_marketplace\Polygon 2.jpg", "description": "Fixed gear bike for a minimalist and stylish ride experience."},
}
